...
class EdgeGPTBot:
    ...
    async def ask(self, query, wss_link="wss://sydney.bing.com/sydney/ChatHub",
                  conversation_style=ConversationStyle.creative, **options):
        completion = await self._bot.ask(prompt=query, wss_link=wss_link, conversation_style=conversation_style)
